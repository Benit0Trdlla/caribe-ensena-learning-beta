...
export default function ProgresoFrancesBasico1Page() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('FrancesBasico1', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('FrancesBasico1');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso Francés Básico 1</h1>
