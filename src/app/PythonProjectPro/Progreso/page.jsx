...
export default function ProgresoPythonProjectProPage() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('PythonProjectPro', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('PythonProjectPro');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso Python Project Pro</h1>
