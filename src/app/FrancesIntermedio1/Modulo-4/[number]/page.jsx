...
function FrancesIntermedio1Page({ params }) {
...
export default withPageAuthRequired(FrancesIntermedio1Page, {
    returnTo: ({ params }) => `/FrancesIntermedio1/Modulo-4/${params.number}`,
});