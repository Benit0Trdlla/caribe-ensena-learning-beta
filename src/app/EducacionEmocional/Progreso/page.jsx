...
export default function ProgresoEducacionEmocionalPage() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('EducacionEmocional', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('EducacionEmocional');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso Educacion Emocional</h1>
