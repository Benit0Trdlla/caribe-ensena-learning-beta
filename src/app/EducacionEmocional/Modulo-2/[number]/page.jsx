...
function EducacionEmocionalPage({ params }) {
...
export default withPageAuthRequired(EducacionEmocionalPage, {
    returnTo: ({ params }) => `/EducacionEmocional/Modulo-2/${params.number}`,
});