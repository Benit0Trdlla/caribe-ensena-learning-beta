...
export default function RootLayout({ children, params }) {
    ...
    const { data: preguntas, isLoading, error } = useDataFromSheets("https://docs.google.com/spreadsheets/d/e/2PACX-1vSAagQo9O1a4jp7zgsp_qfYheapspNI7cv6B4ZvJnp8pxG6oJF2jbJBqi1Trso15zN1T4FX_7z30jG7/pub?output=csv");
    useEffect(() => {
        if (!isLoading && !error) {
            setData(preguntas);
        }
