...
export default function ProgresoEnglishBasic2Page() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('EnglishBasic2', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('EnglishBasic2');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso English Basic 2</h1>
