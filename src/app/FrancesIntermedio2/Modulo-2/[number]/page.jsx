...
function FrancesIntermedio2Page({ params }) {
...
export default withPageAuthRequired(FrancesIntermedio2Page, {
    returnTo: ({ params }) => `/FrancesIntermedio2/Modulo-2/${params.number}`,
});