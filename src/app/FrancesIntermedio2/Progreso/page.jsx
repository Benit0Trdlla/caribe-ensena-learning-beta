...
export default function ProgresoFrancesIntermedio2Page() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('FrancesIntermedio2', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('FrancesIntermedio2');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este es el progreso del curso Francés Intermedio 2</h1>
