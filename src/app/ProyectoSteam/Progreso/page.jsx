...
export default function ProgresoProyectoSteamPage() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('ProyectoSteam', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('ProyectoSteam');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso Proyecto Steam</h1>
