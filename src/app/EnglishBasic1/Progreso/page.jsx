...
export default function ProgresoEnglishBasic1Page() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('EnglishBasic1', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('EnglishBasic1');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso English Basic 1</h1>
