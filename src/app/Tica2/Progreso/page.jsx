...
export default function ProgresoTica2Page() {
    ...
    const openModal = (modulo) => {
        ...
        const { correct, inCorrect } = readQuestionsData('Tica2', modulo.number);
        setInCorrect(inCorrect);
        setCorrect(correct);
    }

    const { Modulo1, Modulo2, Modulo3, Modulo4 } = readPercentage('Tica2');
    ...
    return (
        <>
            <h1 className='text-center mt-3'>Este el progreso del curso Tica 2</h1>
